...
echo "ec2-instance ansible_host=$SERVER_IP ansible_user=ubuntu ansible_ssh_private_key_file=devops.pem ansible_ssh_common_args='-o StrictHostKeyChecking=no'" >> inventory.ini